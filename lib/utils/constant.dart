...
Future<dynamic> checkInApi({
  ...
  var headers = {
    'user_id': userId,
    'user_token': '7pehy1AKqz9DEGbot17Ng5SqWsQIKPBmGuo1bjVlu1rXCCvBK6kU6ICU9Wjw4uwErX',
    'Content-Type': 'application/json',
    'Authorization': 'Bearer $token'
  };
  var request = http.Request('POST', Uri.parse('https://hrms.meestdrive.in/api/employees/check-in'));
